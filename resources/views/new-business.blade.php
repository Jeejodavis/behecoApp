...
<!------------------------------------------------------------------Banner------------------------------------------------------------------>
                    ...
                    <div class="col-xl-8">
                                            ...
                                            <div class="general-info">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label">Name of Founder (Optional)
                                                            </label>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger d-none" id="building_error">Building cannot be empty!</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <form name="image_form" id="image_form" method="post" enctype="multipart/form-data" action="addBusinessPhotos">
                                        ...
                                        <div class="add-photos-section">
                                            <h3 class="custom-h text-center">Add <span>Photos of your Business</span></h3>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="location-wrapper">
                                        ...
                                        <!-- <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m26!1m12!1m3!1d291.94309037737787!2d76.58947476060854!3d10.107077075406194!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m11!3e0!4m3!3m2!1d10.1070728!2d76.5893272!4m5!1s0x3b07e5cc63ace517%3A0xbaeb093424efee5f!2sThrikkariyoor%2C%20Kerala!3m2!1d10.1012659!2d76.6008334!5e0!3m2!1sen!2sin!4v1630769291593!5m2!1sen!2sin"
    ...
    <script src="{{ asset('js/custom/new-business.js') }}"></script>
